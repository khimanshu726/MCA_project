...
export const categoryMenu = [
  ...
  { label: "Institutions", category: "Institutional Supplies" },
];
...
export const products = [
  ...
  // Institutional Supplies — for schools, universities & colleges. Placeholder
  // pricing/imagery; refine in the admin panel. Bulk/custom runs route through
  // the "Request a bulk quote" flow on the Institutions page.
  {
    id: "question-papers",
    name: "Question Papers",
    price: 8,
    category: "Institutional Supplies",
    description: "Confidential exam question paper printing with secure handling for schools, colleges, and universities.",
    images: createImageSet(stockImages.flyers),
    badge: "Exam Season",
    leadTime: "Ready in 3-5 days",
  ...
  },
  {
    ...
    price: 140,
    category: "Institutional Supplies",
    description: "Durable hardbound attendance registers for classrooms, departments, and staff rooms.",
    images: createImageSet(stockImages.notebook),
    badge: "Hardbound",
    leadTime: "Ready in 4-6 days",
    materials: ["Hardbound", "Ruled pages", "Long-life stock"],
    minimum: "MOQ 10",
    audience: "Schools, colleges & universities",
  },
  {
    ...
    price: 320,
    category: "Institutional Supplies",
    description: "Institutional General Register (admission & withdrawal) with archival-grade paper and custom ruling.",
    images: createImageSet(stockImages.notebook),
    badge: "Archival",
    leadTime: "Ready in 5-7 days",
    materials: ["Archival paper", "Custom ruling", "Hardbound"],
    minimum: "MOQ 5",
    audience: "Schools, colleges & universities",
  },
  {
    ...
    price: 60,
    category: "Institutional Supplies",
    description: "Employee service record books for staff HR records, printed to institutional format.",
    images: createImageSet(stockImages.notebook),
    leadTime: "Ready in 4-6 days",
    materials: ["Standard format", "Ruled", "Bound"],
    minimum: "MOQ 10",
    audience: "Schools, colleges & universities",
  },
  {
    ...
    price: 6,
    category: "Institutional Supplies",
    description: "Ruled examination answer booklets with cover page fields and optional serial numbering.",
    images: createImageSet(stockImages.flyers),
    badge: "Exam Season",
    leadTime: "Ready in 3-5 days",
